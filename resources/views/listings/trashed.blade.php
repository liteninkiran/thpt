                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $listing->name }}
                                                        <div class="table-links">
                                                            <a href="{{ route('admin.listings.undelete', $listing->id) }}">Restore</a><div class="bullet"></div>
                                                            <a href="{{ route('admin.listings.remove', $listing->id) }}">Delete</a>
                                                        </div>
                                                    </td>
                                                    ...
                                                    {{-- Date Trashed --}}
                                                    <td>{{ $listing->deleted_at->diffForHumans() }}</td>

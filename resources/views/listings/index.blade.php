                        ...
                        <div class="card mb-0">
                            ...
                            <div class="card-body">
                                ...
                                <ul class="nav nav-pills">
                                    <li class="nav-item"><a class="nav-link active" href="{{ route('admin.listings.index') }}">All <span class="badge badge-white">{{ $listings->total() }}</span></a></li>
                                    <li class="nav-item"><a class="nav-link" href="">Trash <span class="badge badge-primary">{{ $trashed->count() }}</span></a></li>
                                </ul>
